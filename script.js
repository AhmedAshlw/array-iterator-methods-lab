...
// Enter your solution code here:
inventorNames = inventors.map((inv) => inv.first +', '+ inv.last)
...
inventorNamedAda = inventors.find((same) => same.first === 'Ada')
...
// Enter your solution code here:
isAdultPresent = devs.some((nbr) => (2024 - nbr.year) >= 18)
...
// Enter your solution code here:
isEveryone19OrOlder = devs.every((nbr) => (2024 - nbr.year) >= 19)
...
// Enter your solution code here:
commentById = comments.find((nbr) => nbr.id == 823423)
...
// Enter your solution code here:
idx = comments.findIndex((nbr) => nbr.id == 123523)
